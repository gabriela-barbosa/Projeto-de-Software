...
--
-- Host: localhost    Database: prisao
-- ------------------------------------------------------
...
CREATE TABLE `prisao` (
  ...
  `nivel_seguranca` varchar(30) NOT NULL,
...
INSERT INTO `prisao` VALUES (1,210,'bangu','maxima',0),(2,290,'agua santa','minima',0);
...
-- Dump completed on 2019-09-15 20:06:36
