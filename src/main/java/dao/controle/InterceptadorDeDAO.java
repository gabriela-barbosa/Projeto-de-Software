...
public class InterceptadorDeDAO implements MethodInterceptor {
	...
	public Object intercept(Object objeto, Method metodo, Object[] args, MethodProxy metodoDoProxy)
		throws Throwable {
		...
		if (metodo.isAnnotationPresent(RecuperaLista.class)) {
			...
			throw new InfraestruturaException("O método " + metodo.getName() + 
					                          " da classe " + metodo.getDeclaringClass() + 
					                          " não foi anotado");
		}
	}
}
